...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'animo',
    title: 'ANIMO',
    description: 'AI-powered prosthetic hand combining computer vision, embedded AI, and real-time inference.',
    image: '/assets/images/projects/animo.png',
    mainCategory: 'Robotics',
    categories: ['Robotics'],
    technologies: 'Deep Learning • Embedded AI • Computer Vision',
    overview: 'A prosthetic hand platform that uses computer vision and embedded intelligence to interpret hand intent and drive safe control actions.',
    problem: 'The goal was to make prosthetic interaction more intuitive by reducing latency and improving the accuracy of gesture-based control in real time.',
    solution: 'I combined a lightweight vision pipeline with an embedded AI inference path and a high-speed control loop to interpret user intent and execute commands reliably.',
    architecture: 'The design separates sensing, inference, control, and feedback to keep the system responsive and modular.',
    stack: ['Python', 'PyTorch', 'TensorRT', 'C++', 'Embedded Linux', 'ROS2'],
    features: ['Real-time gesture recognition', 'Embedded inference', 'Low-latency control', 'Adaptive calibration'],
    challenges: ['Latency optimization', 'Resource constraints', 'Robust sensor fusion'],
    results: ['Faster response cycles', 'Improved usability', 'Lower power footprint'],
    gallery: ['/assets/images/projects/animo.png'],
